...
export const getAllShipmentDetailForProject = async (projectId) => {
    const { data } = await guestInstance.get(`shipmentdetails/getAllShipmentDetailForProject/${projectId}`)
    return data
}
