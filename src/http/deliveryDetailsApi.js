...
export const getAllDeliveryDetailsForProject = async (projectId) => {
    const { data } = await guestInstance.get(`deliverydetails/getAllDeliveryDetailsForProject/${projectId}`)
    return data
}
