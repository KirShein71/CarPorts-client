...
import {
  fetchOneShipmentOrderDetail,
  updateShipmentOrderDetails,
  deleteOneShipmentOrderDetail,
} from '../../../http/shipmentOrderApi';
...
const UpdateShipmentOrderDetail = (props) => {
  ...
  React.useEffect(() => {
    if (show) {
      fetchOneShipmentOrderDetail(id)
        .then((data) => {
          const prod = {
  ...
  const handleSubmit = async (event) => {
    ...
    if (correct.shipment_quantity) {
      ...
      setIsLoading(true);
      updateShipmentOrderDetails(id, data)
        .then((data) => {
          const prod = {
            shipment_quantity: data.shipment_quantity.toString(),
          };
  ...
  const handleConfirmDelete = () => {
    deleteOneShipmentOrderDetail(id)
      .then(() => {
        setShow(false);
        setChange((state) => !state);
...
export default UpdateShipmentOrderDetail;
