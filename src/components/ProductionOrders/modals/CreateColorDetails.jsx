...
import { fetchOneProjectDetails, createColorProjectDetails } from '../../../http/projectDetailsApi';
...
const CreateColorDetails = (props) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (correct.color) {
      ...
      setIsLoading(true);
      createColorProjectDetails(id, data)
        .then((data) => {
          const prod = {
            color: data.color.toString(),
          };
...
export default CreateColorDetails;
